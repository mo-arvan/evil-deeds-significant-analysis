# sacrebleu results/rethinking/test.en -i results/rethinking/evaluation_logs/model-save-dir-3/clean.result -m bleu
...
directory_path = "results/rethinking/evaluation_logs"

file_list = []
# Get a list of files in the directory
for d in os.listdir(directory_path):
    for file in os.listdir(os.path.join(directory_path, d)):
        if file.endswith("clean.result"):
...
reference_files = ["results/rethinking/test.en"]
...
csv_file_path = "results/permuate_paired_bootstrap_mt.csv"
